...
| [[test_ops_app]] | TEST-033 | test | MOD-011 Textual TUI (FILE-040) — worker survives raising action (app not exited), gated confirm-modal flow (confirm runs+audits, cancel no-op); headless run_test (4 tests) |
...
- **Frontmatter coverage**: 221/221 content nodes (100%)
- **Canonical ID coverage**: 221/221 content nodes (100%)
