...
export function Architecture() {
  return (
    <section className="panel">
      ...
      <div className="lyr l3"><b>LAYER 3 — El Niño</b> &nbsp;<span style={{ color: "var(--accd)" }}>C:\Code\el_nino</span><br />Snapshot Consumer → Feature Builder → Regime Classifier → Gold Decision Builder → Paper Runtime (ADMIT / HOLD / REJECT). dev_graph: ~140 nodes · ~920 edges · ADR-001–009 · Neo4j + PostgreSQL + Obsidian.</div>
